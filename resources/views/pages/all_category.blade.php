                ...
                <div class="shop_content">
                    ...
                    <div class="product_grid row">
                        ...
                        <div class="product_item is_new">
                            ...
                            <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src=" {{ asset($pro->image_one) }} " style="height: 200px;" alt=""></div>
                            <div class="product_content">
                                @if ($pro->discount_price == NULL)
                                            <div class="product_price discount">$ {{$pro->selling_price}} <span> </span></div>
                                            @else
                                            <div class="product_price discount"> ${{$pro->discount_price}} <span> <strike> ${{$pro->selling_price}} </strike> </span></div>
                                            @endif
