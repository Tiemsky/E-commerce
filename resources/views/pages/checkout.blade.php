				...
				<div class="col-lg-12">
					<div class="cart_container">
						...
						<div class="order_total_content" style="padding: 15px;">
							...
							<form action=" {{ route('apply.coupon') }} " method="POST">
								...
								<div class="form-group col-lg-4">
									<input type="text" name="coupon" class="form-control" required placeholder="Coupon">
								</div>
								<button type="submit" class="btn btn-danger ml-2">Submit</button>
							</form>
							@endif
						</div>
						<ul class="list-group col-lg-4 float-right">
							@if (Session::has('coupon'))
						...
						<div class="cart_buttons">
							...
							<a class="button cart_button_checkout" href=" {{ route('payment.step') }} ">Payer</a>
						</div>
					</div>
				</div>
			</div>
