        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 char_col">
                ...
                <div class="char_item d-flex flex-row align-items-center justify-content-start">
                    ...
                    <div class="char_content">
                        ...
                        <div class="char_subtitle">à partir de 5000 FCFA</div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 char_col">
                ...
                <div class="char_item d-flex flex-row align-items-center justify-content-start">
                    ...
                    <div class="char_content">
                        <div class="char_title">Retour de commandes</div>
                        <div class="char_subtitle">sur 3 jours</div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 char_col">
                ...
                <div class="char_item d-flex flex-row align-items-center justify-content-start">
                    ...
                    <div class="char_content">
                        <div class="char_title">Paiement à la livraison</div>
            ...
            <div class="col-lg-3 col-md-6 char_col">
                ...
                <div class="char_item d-flex flex-row align-items-center justify-content-start">
                    ...
                    <div class="char_content">
                        <div class="char_title">Meilleure réduction</div>
                        <div class="char_subtitle"></div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="deals_slider_container">
                        ...
                        <div class="owl-carousel owl-theme deals_slider">
                                    ...
                                    <div class="owl-item deals_item">
                                        ...
                                        @else
                                        <div class="deals_item_price_a ml-auto"><strike>${{ $ht->selling_price }}</strike> </div>
                                        @endif
                                ...
                                <div class="featured_slider_item">
                                    ...
                                    <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                        ...
                                        <div class="product_content">
                                            ...
                                            @else
                                            <div class="product_price discount"> ${{$row->discount_price}} <span> <strike> ${{$row->selling_price}} </strike> </span></div>
                                            @endif
                                            <div class="product_name"><div><a href="{{ url('product/details/'.$row->id.'/'.$row->product_name) }}">{{ $row->product_name }}</a></div></div>
                                            {{-- <div class="product_extras">
                                            
                                                <button class="product_cart_button addcart" data-id="{{ $row->id }}" >Ajoutez au panier</button>
                                            </div> --}}
                                            <div class="product_extras">
                                            
                                                <button id="{{ $row->id }}" class="product_cart_button addcart" data-toggle="modal" data-target="#cartmodal" onclick="productview(this.id)">Ajoutez au panier</button>
                                            </div>
                                        </div>
                        ...
                        <div class="row fill_height">
                            <div class="col-lg-4 col-md-6 fill_height">
                                <div class="banner_2_content">
                                    ...
                                    <div class="button banner_2_button"><a href="#">Explorez</a></div>
                                </div>
                                
                            </div>
                            <div class="col-lg-8 col-md-6 fill_height">
                                <div class="banner_2_image_container">
                                    <div class="banner_2_image"><img src="{{ asset( $row->image_one ) }}" alt=""  ></div>
                                </div>
                            </div>
                        </div>
                    </div>			
                                        ...
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            ...
                                            <div class="product_content">
                                                ...
                                                <div class="product_extras">
                                                    ...
                                                    <button class="product_cart_button">Ajoutez au panier</button>
                                                </div>
                                            </div>
                                            <a class="addwishlist" data-id=" {{ $row->id }} ">
                                                <div class="product_fav"><i class="fas fa-heart"></i></div>
                            ...
                            <div class="trends_item is_new">
                                ...
                                <div class="trends_content">
                                    ...
                                    <div class="trends_info clearfix">
                                        ...
                                        @endif
                                        <br>
                                        <a href="" class="btn btn-danger btn-sm">Ajoutez au panier</a>
                                    </div>
                                </div>
            ...
            <div class="col">
                ...
                <div class="viewed_slider_container">
                    ...
                    <div class="owl-carousel owl-theme viewed_slider">
                        ...
                        <div class="owl-item">
                            <div class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                <div class="viewed_image"><img src="{{ asset('frontend/mages/view_3.jpg') }}i" alt=""></div>
                                <div class="viewed_content text-center">
            ...
            <div class="col">
                <div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
                    <div class="newsletter_title_container">
                        ...
                        <div class="newsletter_text"><p>...et recevez un bon de réduction de 20 % pour votre premier achat.</p></div>
                    </div>
                    <div class="newsletter_content clearfix">
                        <form action="{{ route('store.newsletter') }}"  method="POST" class="newsletter_form">
                            @csrf
                            <input type="email" class="newsletter_input" required="required" placeholder="Entrez votre adresse e-mail" name="email">
...
<!-- Modal -->
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLavel">Vue d'ensemble du produit</h5>
        ...
        <div class="modal-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="" class="text-center" alt="" id="pimage" style="height: 220px;">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <ul class="list-group">
                    <li class="list-group-item font-italic font-weight-light">Product Code: <span id="pcode"></span> </li>
                    <li class="list-group-item font-italic font-weight-light">Category: <span id="pcat"></span> </li>
                    <li class="list-group-item font-italic font-weight-light">Subcategory: <span id="psub"></span> </li>
                    <li class="list-group-item font-italic font-weight-light">Brand: <span id="pbrand"></span> </li>
