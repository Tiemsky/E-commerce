...
<div class="sl-mainpanel">
    ...
    <a class="breadcrumb-item" href="index.html">Kaebor Boutique</a>
    ...
    <div class="row row-sm">
        ...
        <div class="card pd-20 bg-primary">
            ...
            <span class="sparkline2">1,3,9,6,5,9,7,3,5,2</span>
            <h3 class="mg-b-0 tx-white tx-lato tx-bold">{{ $today }} FCFA</h3>
            </div><!-- card-body -->
        ...
        <div class="card pd-20 bg-info">
            ...
            <h3 class="mg-b-0 tx-white tx-lato tx-bold">{{ $month }} FCFA</h3>
            </div><!-- card-body -->
            <div class="d-flex align-items-center justify-content-between mg-t-15 bd-t bd-white-2 pd-t-10">
        ...
        <div class="card pd-20 bg-warning">
            ...
            <div class="d-flex align-items-center justify-content-between">
            <span class="sparkline2">5,3,9,6,5,9,7,3,5,2</span>
            <h3 class="mg-b-0 tx-white tx-lato tx-bold">{{ $delivery }} FCFA</h3>
            </div><!-- card-body -->
            <div class="d-flex align-items-center justify-content-between mg-t-15 bd-t bd-white-2 pd-t-10">
        ...
        <div class="card pd-20 bg-sl-primary">
            ...
            <div class="d-flex align-items-center justify-content-between">
            <span class="sparkline2">5,3,9,6,5,9,7,3,5,2</span>
            <h3 class="mg-b-0 tx-white tx-lato tx-bold">{{ $year }} FCFA</h3>
            </div><!-- card-body -->
            <div class="d-flex align-items-center justify-content-between mg-t-15 bd-t bd-white-2 pd-t-10">
            </div><!-- -->
        </div><!-- card -->
    ...
    <div class="row row-sm">
        ...
        <div class="card pd-20 bg-danger">
            ...
            <div class="d-flex align-items-center justify-content-between">
            <span class="sparkline2">1,3,9,6,5,9,7,3,5,2</span>
            <h3 class="mg-b-0 tx-white tx-lato tx-bold">{{ $return }} FCFA</h3>
            </div><!-- card-body -->
            <div class="d-flex align-items-center justify-content-between mg-t-15 bd-t bd-white-2 pd-t-10">
            </div><!-- -->
    ...
    <br>
    <div class="">
        <iframe frameBorder="0" width="1200" height="350" src="https://kwize.com/quote-of-the-day/embed/&txt=0&font=&color=000000&background=de2121&fid=inspiration"></iframe>
    </div>
