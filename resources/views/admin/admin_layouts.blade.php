...
<div class="sl-sideleft">
    ...
    <a href="#" class="sl-menu-link">
        ...
        <span class="menu-item-label">Catégorie</span>
        <i class="menu-item-arrow fa fa-angle-down"></i>
        </div><!-- menu-item -->
    </a><!-- sl-menu-link -->
    <ul class="sl-menu-sub nav flex-column">
        <li class="nav-item"><a href="{{ route('category.index') }}" class="nav-link">Catégorie</a></li>
        <li class="nav-item"><a href="{{route('sub.categories')}}" class="nav-link">Sous Catégorie</a></li>
    ...
    <ul class="sl-menu-sub nav flex-column">
        ...
        <li class="nav-item"><a href="{{route('admin.accept.payment')}}" class="nav-link">Commandes acceptées</a></li>
        <li class="nav-item"><a href="{{route('admin.cancel.order')}}" class="nav-link">Commandes annulées</a></li>
        <li class="nav-item"><a href="{{route('admin.process.payment')}}" class="nav-link">Processus de livraison</a></li>
        <li class="nav-item"><a href="{{route('admin.success.payment')}}" class="nav-link">Commandes livrées</a></li>
    </ul>
    ...
    <ul class="sl-menu-sub nav flex-column">
        <li class="nav-item"><a href="{{ route('add.blog.categorylist') }}" class="nav-link">Catégorie Blog</a></li>
    ...
    <a href="#" class="sl-menu-link">
        ...
        <span class="menu-item-label">Abonnés</span>
        <i class="menu-item-arrow fa fa-angle-down"></i>
        </div><!-- menu-item -->
    </a><!-- sl-menu-link -->
    <ul class="sl-menu-sub nav flex-column">
        <li class="nav-item"><a href="{{route('admin.newsletter')}}" class="nav-link">Bulletin d'informations</a></li>
        <li class="nav-item"><a href="{{route('admin.seo')}}" class="nav-link">Paramètres SEO</a></li>
    </ul>
    ...
    <ul class="sl-menu-sub nav flex-column">
        <li class="nav-item"><a href="{{ route('create.admin') }}" class="nav-link">Créez un utilisateur</a></li>
    ...
    <a href="#" class="sl-menu-link">
        ...
        <span class="menu-item-label">Commandes retournées</span>
        <i class="menu-item-arrow fa fa-angle-down"></i>
        </div><!-- menu-item -->
    </a><!-- sl-menu-link -->
    <ul class="sl-menu-sub nav flex-column">
        <li class="nav-item"><a href="{{ route('admin.return.request') }}" class="nav-link">Demande de renvoi</a></li>
        <li class="nav-item"><a href="{{ route('admin.all.return') }}" class="nav-link">Liste des Requêtes</a></li>
    </ul>
    ...
    <a href="#" class="sl-menu-link">
        ...
        <span class="menu-item-label">Paramètres du site</span>
        <i class="menu-item-arrow fa fa-angle-down"></i>
        </div><!-- menu-item -->
    </a><!-- sl-menu-link -->
    <ul class="sl-menu-sub nav flex-column">
        <li class="nav-item"><a href="{{ route('admin.site.setting') }}" class="nav-link">Paramètres du site</a></li>
    </ul>
...
<script>  
    $(document).on("click", "#delete", function(e){
        ...
        swal({
            title: "Etes-vous sûr ?",
            text: "Une fois effacé, vous ne pourrez pas récupérer les données",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        })
