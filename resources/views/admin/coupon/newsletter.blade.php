...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        ...
        <h6 class="card-body-title">Abonnés
        <a href="#" class="btn btn-sm btn-warning float-right" data-toggle="modal" data-target="#modaldemo3">All Delete</a>
        </h6>
        ...
        <div class="table-wrapper">
            ...
            <thead>
                ...
                <th class="wd-15p">Heure de l'abonnement</th>
            ...
            <tbody>
                ...
                <td>
                    <a href="{{ URL::to('delete/sub/'.$row->id) }}" class="btn btn-sm btn-danger" id="delete">Supprimer</a>
                </td>
