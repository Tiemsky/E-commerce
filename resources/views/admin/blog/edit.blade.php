...
<div class="card pd-20 pd-sm-40">
    ...
    <p class="mg-b-20 mg-sm-b-30">Mise à jour du Blog</p>
    ...
    <div class="form-layout">
        ...
        <div class="col-lg-4">
            <div class="form-group">
                <label class="form-control-label">Ancienne image du Post: <span class="tx-danger">*</span></label>
                <label class="custom-file">
        ...
        <button class="btn btn-info mg-r-5" type="submit"><i class="fa fa-floppy-o fa-lg" aria-hidden="true"></i>&nbsp; Actualiser</button>
