...
class PaymentController extends Controller
{
    public function Payment (Request $request){
        ...
        if ($request->payment == 'stripe') {
            ...
            return view('pages.payment.stripe',compact('data'));
                ...
                $notification=array(
                    'messege'=>'You must select a Payment method!',
                    'alert-type'=>'error'
                    );
    ...
    public function StripeCharge(Request $request){
        ...
        \Stripe\Stripe::setApiKey('sk_test_51JAaiPSJpx4awhAMZOJHSRrjapY3hqvwx4766EMjbIyLCtD27Cr6pLrdDqIzPYdLGHpJ9W2V7OXCml7Mc91uGV7F00zAKcGf2W');
        ...
        //Mail Send to the User for Invoice
