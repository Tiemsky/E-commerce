...
class ProductController extends Controller
{
    ...
    public function store(Request $request){
        ...
        if ($image_one && $image_two && $image_three) {
            ...
            $notification=array(
                    'messege'=>'Produit inséré avec succès',
                    'alert-type'=>'success'
                    );
    ...
    public function inactive($id){
        ...
        $notification=array(
                'messege'=>'Produit désactivé avec succès',
                'alert-type'=>'success'
                );
            return Redirect()->back()->with($notification);
    }
    ...
    public function active($id){
        ...
        $notification=array(
            'messege'=>'Produit activé avec succès',
            'alert-type'=>'success'
            );
            return Redirect()->back()->with($notification);
    }
    ...
    public function UpdateProductPhoto(Request $request,$id){
        ...
        if ($image_one) {
            ...
            $notification=array(
                'messege'=>'Image 1 a été mise à jour avec succès',
                'alert-type'=>'success'
                );
                return Redirect()->route('all.product')->with($notification);
    }
    if ($image_two) {
            ...
            $productimg = DB::table('products')->where('id',$id)->update($data);
            $notification=array(
                'messege'=>'Image 2 a été mise à jour avec succès',
                'alert-type'=>'success'
                );
                return Redirect()->route('all.product')->with($notification);
    ...
    if ($image_three) {
            ...
            $productimg = DB::table('products')->where('id',$id)->update($data);
            $notification=array(
                'messege'=>'Image 3 a été mise à jour avec succès',
                'alert-type'=>'success'
                );
                return Redirect()->route('all.product')->with($notification);
    }
